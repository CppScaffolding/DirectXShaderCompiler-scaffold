# -----------------------------------------------------------------------------
# DEPS file for DirectXShaderCompiler scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# DirectXShaderCompiler-scaffold scaffold repo.
...
vars = {
  ...
  # this
  # line
  'DirectXShaderCompiler_revision': '',
  # keep
  # this
  # line
  # ---------------------------------------------------------------------------
...
deps = {
  ...
  # this
  # line
  'DirectXShaderCompiler': 'https://github.com/Microsoft/DirectXShaderCompiler.git@{DirectXShaderCompiler_revision}',
  # keep
  # this
  # line
}
